...
class DiscordUtils
{
    ...
    private static string $_bot_url;

    private static string $_bot_username;
     ...
     */
    public static function getDiscordRoleId(int $nameless_group_id): ?int {
        $nameless_injector = \GroupSyncManager::getInstance()->getInjectorByClass(\NamelessMCGroupSyncInjector::class);

        $discord_role_id = \DB::getInstance()->get('group_sync', [$nameless_injector->getColumnName(), $nameless_group_id]);
    ...
    public static function botRequest(string $url, ?string $body = null) {
        $client = \HttpClient::post(self::botUrl() . $url, $body);
    ...
    public static function botUrl(): string {
        ...
        return self::$_bot_url = $bot_url;
    }

    public static function botUsername(): string {
        if (isset(self::$_bot_username)) {
        ...
        return self::$_bot_username = $bot_username;
    }
